...
describe("product store", () => {
    ...
    it("should add multiple products", () => {
        const { setProducts } = useProductStore.getState();
        setProducts([{id: 1, title: "Product A"}, {id: 2, title: "Product B"}]);
    ...
    it("should set filtered products based on tag", () => {
        ...
        setProducts([{id: 1, title: "Product A", tags: ["tagA"]}, {id: 2, title: "Product B", tags: ["tagB"]}]);
        setFilterTag("tagA");
    ...
    it("should set filtered products based on sale", () => {
        ...
        setProducts([{id: 1, title: "Product A", tags: ["tagA"], price: 10, discountedPrice: 10}, {id: 2, title: "Product B", tags: ["tagB"], price: 10, discountedPrice: 5}]);
        setOnSale();
        ...
        expect(filteredProducts).toHaveLength(1);
        expect(filteredProducts).toEqual([
            {id: 2, title: "Product B", tags: ["tagB"], price: 10, discountedPrice: 5},
        ]);
    });
    ...
    it ("should clear filtered products", () => {
        const { setProducts, setSearchQuery, clearFilter } = useProductStore.getState();
