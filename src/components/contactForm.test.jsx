...
describe("ContactForm", () => {
    ...
    it("should update input value on change", () => {
        ...
        fireEvent.change(emailInput, {target: {value: "OlaNormann@stud.noroff.no"}});
        fireEvent.change(messageInput, {target: {value: "I was promised my products by now, where is it?"}});
        ...
        expect(messageInput.value).toBe("I was promised my products by now, where is it?");
    });
    ...
    it("should display matching error when inputs are invalid", async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText("emailAddress is a required field")).toBeInTheDocument();
            expect(screen.getByText("Message must be at least 3 characters")).toBeInTheDocument();    
        });

        const emailInput = screen.getByLabelText("Email");
        fireEvent.change(emailInput, {target: {value: "OlaNormannatstud.noroff.no"}});
