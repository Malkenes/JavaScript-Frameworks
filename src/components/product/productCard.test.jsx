...
describe("ProductCard", () => {
    it("should display information correctly", () => {
        const mockData = {
            ...
            price: 100,
            discountedPrice: 10,
            image: {url: "https://this.mockImage.isfake/3", alt: "this is text for an image"},
        };
        ...
        expect(screen.getByRole("img", {url: "https://this.mockImage.isfake/3", alt: "this is text for an image" }))
