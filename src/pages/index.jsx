...
import { StyledAnchor } from "../components/Button.styles";
    ...
    <StyledIndex>
      <StyledHero>
        <section>
          ...
          <div>
            ...
            <p>
              Welcome to our online store, where we offer a carefully curated
              selection of high-quality products that cater to your every need
            </p>
      ...
      <StyledDiscover>
        ...
        <StyledDiscoverItem>
          ...
          <h3>Beauty</h3>
          Unleash your inner glow with our luxurious beauty essentials, crafted
        ...
        <StyledDiscoverItem>
          ...
          <h3>Hobby</h3>
          Fuel your passions and explore new horizons with our diverse range of
          hobby supplies, perfect for every enthusiast
        </StyledDiscoverItem>
      </StyledDiscover>
      <StyledAbout>
        <div>
          <div>
            <h2>About Us</h2>
            <p>
              Welcome to QuickBox, your one-stop shop for everything you need!
              Our mission is simple: to make shopping easy, enjoyable, and
              tailored to your lifestyle.
            </p>
            <p>
              At QuickBox, we believe in putting our customers first. Thats why
              we focus on providing top-notch customer service, quick delivery,
              and products that we stand behind. Every item in our store has
              been selected to meet high standards of quality, ensuring you get
              the best, no matter what you&apos;re shopping for.
            </p>
          </div>
        </div>
        <div>
  ...
  return (
    <StyledFilterBar>
      ...
      {filterListArray.map((filter) => (
        <button key={filter.tag} onClick={() => setFilterTag(filter.tag)}>
          {filter.tag}
        </button>
      ))}
    </StyledFilterBar>
